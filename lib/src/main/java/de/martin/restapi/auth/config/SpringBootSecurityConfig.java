package de.martin.restapi.auth.config;
...
import de.martin.restapi.auth.jwt.JwtFilter;
...
public class SpringBootSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private CustomUserDetailsService customUserDateilsService;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(customUserDateilsService);
	}
